...
In Bitbucket 4.12 and later versions, permissions of the volume is managed by entry scripts. To get started you can use a data volume, or named volumes. In this example we'll use named volumes.
